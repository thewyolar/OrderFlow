...
public class MerchantController {
    ...
    public ResponseEntity<MerchantResponseDTO> getMerchant(@PathVariable UUID merchantId) throws NotFoundException {
        return ResponseEntity.ok(merchantService.getMerchantById(merchantId));
    }

    @DeleteMapping("/{merchantId}")
    public ResponseEntity<String> deleteOrder(@PathVariable UUID merchantId) throws NotFoundException {
    ...
    public ResponseEntity<Merchant> updateMerchant(@PathVariable UUID merchantId, @RequestBody MerchantDTO merchantDTO) throws NotFoundException {
